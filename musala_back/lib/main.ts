    ...
    Object.keys(this.models).forEach((model) => {
      ...
      this.expressInstance.get(`/${modelName}/:id`, async (req, res) => {
        try {
          ...
          const user = await this.actions.GET_ONE(modelName, queryParams,  parseInt(id));
      ...
      this.expressInstance.get(`/${modelName}`, async (req, res, _next) => {
      ...
      this.expressInstance.put(`/${modelName}/:id`, async (req, res) => {
        try {
          const { id } = req.params;
          const user = await this.actions.UPDATE(modelName,  parseInt(id), req.body);
      ...
      this.expressInstance.delete(`/${modelName}/:id`, async (req, res) => {
        try {
          const { id } = req.params;
          const user = await this.actions.DELETE(modelName, parseInt(id));
